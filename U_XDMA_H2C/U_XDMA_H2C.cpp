...
int main()
{
    ...
    if (DrvDMA_OK == lRet)
    {
        ...
        // d. By setting mFlags.mToDevice to true, we indicate to the drive
        //    that we want to tranfer data from the host memory to the device
        //    (H2C).
        // e. By setting mMem_Index to 1, we indicate to the driver to use
        //    the second configured BAR to access XDMA registers.
        // f. By setting mMem_Offset_byte to 0, we indicate to the driver to
        //    use this offset as base for the XDMA channel registers (first
        //    H2C channel)
